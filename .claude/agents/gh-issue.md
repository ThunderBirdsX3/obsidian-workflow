...
> **obsidian-workflow note:** resolve the repo from `gh repo view --json nameWithOwner -q .nameWithOwner` (run in the project cwd) — never hardcode an owner/repo; this works for any project with `gh` auth + GitHub issues
